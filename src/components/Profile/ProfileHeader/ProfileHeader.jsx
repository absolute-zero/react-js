...
const ProfileHeader = ({savePhoto, isOwner, profile, status, updateStatus}) => {
    if (!profile) {
        return <Preloader/>;
    }
    ...
    const onChangeImg = () => {
        document.getElementById('photoLarge').click();
    }
                ...
                <div className={cx(classes.information, 'app-wrapper')}>
                    <div className={classes['information-avatar']}>
                        <img src={profile.photos.large || UserPhoto} alt=""
                             className={classes['information-avatar-img']} onClick={onChangeImg}/>
                    ...
                    <nav className={classes['information-nav']}>
                        ...
                        {
                            isOwner ? <NavLink to={`/profile/${profile.userId}/setting`}
                                               className={classes['information-nav-element']}>
                                <div className={classes['information-nav-img']}>
